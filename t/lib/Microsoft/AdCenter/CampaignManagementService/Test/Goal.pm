package Microsoft::AdCenter::CampaignManagementService::Test::Goal;
...
use Microsoft::AdCenter::CampaignManagementService::Goal;

sub test_can_create_goal_and_set_all_fields : Test(8) {
    my $goal = Microsoft::AdCenter::CampaignManagementService::Goal->new
