package Microsoft::AdCenter::CampaignManagementService::Test::Business;
...
use Microsoft::AdCenter::CampaignManagementService::Business;

sub test_can_create_business_and_set_all_fields : Test(22) {
    my $business = Microsoft::AdCenter::CampaignManagementService::Business->new
