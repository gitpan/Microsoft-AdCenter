package Microsoft::AdCenter::CampaignManagementService::Test::MobileAd;
...
use Microsoft::AdCenter::CampaignManagementService::MobileAd;

sub test_can_create_mobile_ad_and_set_all_fields : Test(7) {
    my $mobile_ad = Microsoft::AdCenter::CampaignManagementService::MobileAd->new
