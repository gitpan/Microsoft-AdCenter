package Microsoft::AdCenter::CampaignManagementService::Test::BehavioralTargetBid;
...
use Microsoft::AdCenter::CampaignManagementService::BehavioralTargetBid;

sub test_can_create_behavioral_target_bid_and_set_all_fields : Test(3) {
    my $behavioral_target_bid = Microsoft::AdCenter::CampaignManagementService::BehavioralTargetBid->new
