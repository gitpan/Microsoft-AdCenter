package Microsoft::AdCenter::CampaignManagementService::Test::MetroAreaTargetBid;
...
use Microsoft::AdCenter::CampaignManagementService::MetroAreaTargetBid;

sub test_can_create_metro_area_target_bid_and_set_all_fields : Test(3) {
    my $metro_area_target_bid = Microsoft::AdCenter::CampaignManagementService::MetroAreaTargetBid->new
