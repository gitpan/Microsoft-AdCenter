package Microsoft::AdCenter::CampaignManagementService::Test::SegmentTargetBid;
...
use Microsoft::AdCenter::CampaignManagementService::SegmentTargetBid;

sub test_can_create_segment_target_bid_and_set_all_fields : Test(9) {
    my $segment_target_bid = Microsoft::AdCenter::CampaignManagementService::SegmentTargetBid->new
