package Microsoft::AdCenter::CampaignManagementService::Test::AdGroup;
...
use Microsoft::AdCenter::CampaignManagementService::AdGroup;

sub test_can_create_ad_group_and_set_all_fields : Test(17) {
    my $ad_group = Microsoft::AdCenter::CampaignManagementService::AdGroup->new
