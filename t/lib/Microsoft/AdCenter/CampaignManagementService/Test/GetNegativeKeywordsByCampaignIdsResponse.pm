package Microsoft::AdCenter::CampaignManagementService::Test::GetNegativeKeywordsByCampaignIdsResponse;
...
use Microsoft::AdCenter::CampaignManagementService::GetNegativeKeywordsByCampaignIdsResponse;

sub test_can_create_get_negative_keywords_by_campaign_ids_response_and_set_all_fields : Test(2) {
    my $get_negative_keywords_by_campaign_ids_response = Microsoft::AdCenter::CampaignManagementService::GetNegativeKeywordsByCampaignIdsResponse->new
