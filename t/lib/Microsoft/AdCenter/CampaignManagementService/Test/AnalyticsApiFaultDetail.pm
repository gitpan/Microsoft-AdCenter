package Microsoft::AdCenter::CampaignManagementService::Test::AnalyticsApiFaultDetail;
...
use Microsoft::AdCenter::CampaignManagementService::AnalyticsApiFaultDetail;

sub test_can_create_analytics_api_fault_detail_and_set_all_fields : Test(3) {
    my $analytics_api_fault_detail = Microsoft::AdCenter::CampaignManagementService::AnalyticsApiFaultDetail->new
