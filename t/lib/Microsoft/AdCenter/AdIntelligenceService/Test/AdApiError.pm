package Microsoft::AdCenter::AdIntelligenceService::Test::AdApiError;
...
use Microsoft::AdCenter::AdIntelligenceService::AdApiError;

sub test_can_create_ad_api_error_and_set_all_fields : Test(5) {
    my $ad_api_error = Microsoft::AdCenter::AdIntelligenceService::AdApiError->new
        ->Code('code')
        ->Detail('detail')
