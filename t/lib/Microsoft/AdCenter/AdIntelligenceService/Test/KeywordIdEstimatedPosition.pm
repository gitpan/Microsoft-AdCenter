package Microsoft::AdCenter::AdIntelligenceService::Test::KeywordIdEstimatedPosition;
...
use Microsoft::AdCenter::AdIntelligenceService::KeywordIdEstimatedPosition;

sub test_can_create_keyword_id_estimated_position_and_set_all_fields : Test(3) {
    my $keyword_id_estimated_position = Microsoft::AdCenter::AdIntelligenceService::KeywordIdEstimatedPosition->new
