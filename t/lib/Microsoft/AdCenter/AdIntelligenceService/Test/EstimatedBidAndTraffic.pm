package Microsoft::AdCenter::AdIntelligenceService::Test::EstimatedBidAndTraffic;
...
use Microsoft::AdCenter::AdIntelligenceService::EstimatedBidAndTraffic;

sub test_can_create_estimated_bid_and_traffic_and_set_all_fields : Test(12) {
    my $estimated_bid_and_traffic = Microsoft::AdCenter::AdIntelligenceService::EstimatedBidAndTraffic->new
