package Microsoft::AdCenter::AdIntelligenceService::Test::GetEstimatedPositionByKeywordsResponse;
...
use Microsoft::AdCenter::AdIntelligenceService::GetEstimatedPositionByKeywordsResponse;

sub test_can_create_get_estimated_position_by_keywords_response_and_set_all_fields : Test(2) {
    my $get_estimated_position_by_keywords_response = Microsoft::AdCenter::AdIntelligenceService::GetEstimatedPositionByKeywordsResponse->new
