package Microsoft::AdCenter::AdIntelligenceService::Test::KeywordKPI;
...
use Microsoft::AdCenter::AdIntelligenceService::KeywordKPI;

sub test_can_create_keyword_kpi_and_set_all_fields : Test(9) {
    my $keyword_kpi = Microsoft::AdCenter::AdIntelligenceService::KeywordKPI->new
