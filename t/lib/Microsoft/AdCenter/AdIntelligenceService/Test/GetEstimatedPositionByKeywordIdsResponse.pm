package Microsoft::AdCenter::AdIntelligenceService::Test::GetEstimatedPositionByKeywordIdsResponse;
...
use Microsoft::AdCenter::AdIntelligenceService::GetEstimatedPositionByKeywordIdsResponse;

sub test_can_create_get_estimated_position_by_keyword_ids_response_and_set_all_fields : Test(2) {
    my $get_estimated_position_by_keyword_ids_response = Microsoft::AdCenter::AdIntelligenceService::GetEstimatedPositionByKeywordIdsResponse->new
