package Microsoft::AdCenter::AdIntelligenceService::Test::OperationError;
...
use Microsoft::AdCenter::AdIntelligenceService::OperationError;

sub test_can_create_operation_error_and_set_all_fields : Test(5) {
    my $operation_error = Microsoft::AdCenter::AdIntelligenceService::OperationError->new
        ->Code('code')
        ->Details('details')
