package Microsoft::AdCenter::AdIntelligenceService::Test::EstimatedPositionAndTraffic;
...
use Microsoft::AdCenter::AdIntelligenceService::EstimatedPositionAndTraffic;

sub test_can_create_estimated_position_and_traffic_and_set_all_fields : Test(12) {
    my $estimated_position_and_traffic = Microsoft::AdCenter::AdIntelligenceService::EstimatedPositionAndTraffic->new
