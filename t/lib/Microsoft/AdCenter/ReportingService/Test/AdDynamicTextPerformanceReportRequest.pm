package Microsoft::AdCenter::ReportingService::Test::AdDynamicTextPerformanceReportRequest;
...
use Microsoft::AdCenter::ReportingService::AdDynamicTextPerformanceReportRequest;

sub test_can_create_ad_dynamic_text_performance_report_request_and_set_all_fields : Test(6) {
    my $ad_dynamic_text_performance_report_request = Microsoft::AdCenter::ReportingService::AdDynamicTextPerformanceReportRequest->new
