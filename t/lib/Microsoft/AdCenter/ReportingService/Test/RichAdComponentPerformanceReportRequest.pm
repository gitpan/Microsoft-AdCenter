package Microsoft::AdCenter::ReportingService::Test::RichAdComponentPerformanceReportRequest;
...
use Microsoft::AdCenter::ReportingService::RichAdComponentPerformanceReportRequest;

sub test_can_create_rich_ad_component_performance_report_request_and_set_all_fields : Test(6) {
    my $rich_ad_component_performance_report_request = Microsoft::AdCenter::ReportingService::RichAdComponentPerformanceReportRequest->new
