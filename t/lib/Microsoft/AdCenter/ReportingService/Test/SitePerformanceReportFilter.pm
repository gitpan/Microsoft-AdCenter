package Microsoft::AdCenter::ReportingService::Test::SitePerformanceReportFilter;
...
use Microsoft::AdCenter::ReportingService::SitePerformanceReportFilter;

sub test_can_create_site_performance_report_filter_and_set_all_fields : Test(7) {
    my $site_performance_report_filter = Microsoft::AdCenter::ReportingService::SitePerformanceReportFilter->new
