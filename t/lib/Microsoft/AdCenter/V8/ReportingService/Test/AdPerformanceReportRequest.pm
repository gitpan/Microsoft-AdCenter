package Microsoft::AdCenter::V8::ReportingService::Test::AdPerformanceReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::AdPerformanceReportRequest;

sub test_can_create_ad_performance_report_request_and_set_all_fields : Test(6) {
    my $ad_performance_report_request = Microsoft::AdCenter::V8::ReportingService::AdPerformanceReportRequest->new
