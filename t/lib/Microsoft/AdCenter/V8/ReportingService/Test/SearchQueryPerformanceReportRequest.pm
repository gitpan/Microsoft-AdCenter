package Microsoft::AdCenter::V8::ReportingService::Test::SearchQueryPerformanceReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::SearchQueryPerformanceReportRequest;

sub test_can_create_search_query_performance_report_request_and_set_all_fields : Test(6) {
    my $search_query_performance_report_request = Microsoft::AdCenter::V8::ReportingService::SearchQueryPerformanceReportRequest->new
