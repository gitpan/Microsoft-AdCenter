package Microsoft::AdCenter::V8::ReportingService::Test::SubmitGenerateReportResponse;
...
use Microsoft::AdCenter::V8::ReportingService::SubmitGenerateReportResponse;

sub test_can_create_submit_generate_report_response_and_set_all_fields : Test(2) {
    my $submit_generate_report_response = Microsoft::AdCenter::V8::ReportingService::SubmitGenerateReportResponse->new
