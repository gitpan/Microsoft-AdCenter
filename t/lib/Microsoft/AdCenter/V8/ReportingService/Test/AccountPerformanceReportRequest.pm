package Microsoft::AdCenter::V8::ReportingService::Test::AccountPerformanceReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::AccountPerformanceReportRequest;

sub test_can_create_account_performance_report_request_and_set_all_fields : Test(6) {
    my $account_performance_report_request = Microsoft::AdCenter::V8::ReportingService::AccountPerformanceReportRequest->new
