package Microsoft::AdCenter::V8::ReportingService::Test::AccountReportScope;
...
use Microsoft::AdCenter::V8::ReportingService::AccountReportScope;

sub test_can_create_account_report_scope_and_set_all_fields : Test(2) {
    my $account_report_scope = Microsoft::AdCenter::V8::ReportingService::AccountReportScope->new
