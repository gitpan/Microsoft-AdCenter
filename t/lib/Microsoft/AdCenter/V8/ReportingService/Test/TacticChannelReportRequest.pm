package Microsoft::AdCenter::V8::ReportingService::Test::TacticChannelReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::TacticChannelReportRequest;

sub test_can_create_tactic_channel_report_request_and_set_all_fields : Test(6) {
    my $tactic_channel_report_request = Microsoft::AdCenter::V8::ReportingService::TacticChannelReportRequest->new
