package Microsoft::AdCenter::V8::ReportingService::Test::PublisherUsagePerformanceReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::PublisherUsagePerformanceReportRequest;

sub test_can_create_publisher_usage_performance_report_request_and_set_all_fields : Test(6) {
    my $publisher_usage_performance_report_request = Microsoft::AdCenter::V8::ReportingService::PublisherUsagePerformanceReportRequest->new
