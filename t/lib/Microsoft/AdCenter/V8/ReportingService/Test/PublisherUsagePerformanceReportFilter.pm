package Microsoft::AdCenter::V8::ReportingService::Test::PublisherUsagePerformanceReportFilter;
...
use Microsoft::AdCenter::V8::ReportingService::PublisherUsagePerformanceReportFilter;

sub test_can_create_publisher_usage_performance_report_filter_and_set_all_fields : Test(3) {
    my $publisher_usage_performance_report_filter = Microsoft::AdCenter::V8::ReportingService::PublisherUsagePerformanceReportFilter->new
