package Microsoft::AdCenter::V8::ReportingService::Test::AdPerformanceReportFilter;
...
use Microsoft::AdCenter::V8::ReportingService::AdPerformanceReportFilter;

sub test_can_create_ad_performance_report_filter_and_set_all_fields : Test(5) {
    my $ad_performance_report_filter = Microsoft::AdCenter::V8::ReportingService::AdPerformanceReportFilter->new
