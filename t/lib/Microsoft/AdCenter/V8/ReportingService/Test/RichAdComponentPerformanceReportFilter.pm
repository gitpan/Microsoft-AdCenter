package Microsoft::AdCenter::V8::ReportingService::Test::RichAdComponentPerformanceReportFilter;
...
use Microsoft::AdCenter::V8::ReportingService::RichAdComponentPerformanceReportFilter;

sub test_can_create_rich_ad_component_performance_report_filter_and_set_all_fields : Test(3) {
    my $rich_ad_component_performance_report_filter = Microsoft::AdCenter::V8::ReportingService::RichAdComponentPerformanceReportFilter->new
