package Microsoft::AdCenter::V8::ReportingService::Test::ReportTime;
...
use Microsoft::AdCenter::V8::ReportingService::ReportTime;

sub test_can_create_report_time_and_set_all_fields : Test(4) {
    my $report_time = Microsoft::AdCenter::V8::ReportingService::ReportTime->new
