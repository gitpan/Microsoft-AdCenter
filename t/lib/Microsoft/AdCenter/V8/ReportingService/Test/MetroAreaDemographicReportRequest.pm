package Microsoft::AdCenter::V8::ReportingService::Test::MetroAreaDemographicReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::MetroAreaDemographicReportRequest;

sub test_can_create_metro_area_demographic_report_request_and_set_all_fields : Test(6) {
    my $metro_area_demographic_report_request = Microsoft::AdCenter::V8::ReportingService::MetroAreaDemographicReportRequest->new
