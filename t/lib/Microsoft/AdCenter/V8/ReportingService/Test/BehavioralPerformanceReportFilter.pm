package Microsoft::AdCenter::V8::ReportingService::Test::BehavioralPerformanceReportFilter;
...
use Microsoft::AdCenter::V8::ReportingService::BehavioralPerformanceReportFilter;

sub test_can_create_behavioral_performance_report_filter_and_set_all_fields : Test(6) {
    my $behavioral_performance_report_filter = Microsoft::AdCenter::V8::ReportingService::BehavioralPerformanceReportFilter->new
