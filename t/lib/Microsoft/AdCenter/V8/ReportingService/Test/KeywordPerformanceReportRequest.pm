package Microsoft::AdCenter::V8::ReportingService::Test::KeywordPerformanceReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::KeywordPerformanceReportRequest;

sub test_can_create_keyword_performance_report_request_and_set_all_fields : Test(6) {
    my $keyword_performance_report_request = Microsoft::AdCenter::V8::ReportingService::KeywordPerformanceReportRequest->new
