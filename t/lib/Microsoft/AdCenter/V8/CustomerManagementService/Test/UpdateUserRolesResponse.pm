package Microsoft::AdCenter::V8::CustomerManagementService::Test::UpdateUserRolesResponse;
...
use Microsoft::AdCenter::V8::CustomerManagementService::UpdateUserRolesResponse;

sub test_can_create_update_user_roles_response_and_set_all_fields : Test(2) {
    my $update_user_roles_response = Microsoft::AdCenter::V8::CustomerManagementService::UpdateUserRolesResponse->new
