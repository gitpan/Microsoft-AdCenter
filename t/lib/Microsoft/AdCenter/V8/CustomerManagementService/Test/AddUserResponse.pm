package Microsoft::AdCenter::V8::CustomerManagementService::Test::AddUserResponse;
...
use Microsoft::AdCenter::V8::CustomerManagementService::AddUserResponse;

sub test_can_create_add_user_response_and_set_all_fields : Test(3) {
    my $add_user_response = Microsoft::AdCenter::V8::CustomerManagementService::AddUserResponse->new
