package Microsoft::AdCenter::V8::CustomerManagementService::Test::UpdateAccountResponse;
...
use Microsoft::AdCenter::V8::CustomerManagementService::UpdateAccountResponse;

sub test_can_create_update_account_response_and_set_all_fields : Test(2) {
    my $update_account_response = Microsoft::AdCenter::V8::CustomerManagementService::UpdateAccountResponse->new
