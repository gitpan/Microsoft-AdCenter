package Microsoft::AdCenter::V8::CustomerManagementService::Test::SignupCustomerResponse;
...
use Microsoft::AdCenter::V8::CustomerManagementService::SignupCustomerResponse;

sub test_can_create_signup_customer_response_and_set_all_fields : Test(7) {
    my $signup_customer_response = Microsoft::AdCenter::V8::CustomerManagementService::SignupCustomerResponse->new
