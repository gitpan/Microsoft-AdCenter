package Microsoft::AdCenter::V8::CampaignManagementService::Test::Business;
...
use Microsoft::AdCenter::V8::CampaignManagementService::Business;

sub test_can_create_business_and_set_all_fields : Test(22) {
    my $business = Microsoft::AdCenter::V8::CampaignManagementService::Business->new
