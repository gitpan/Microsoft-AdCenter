package Microsoft::AdCenter::V8::CampaignManagementService::Test::CampaignScope;
...
use Microsoft::AdCenter::V8::CampaignManagementService::CampaignScope;

sub test_can_create_campaign_scope_and_set_all_fields : Test(3) {
    my $campaign_scope = Microsoft::AdCenter::V8::CampaignManagementService::CampaignScope->new
