package Microsoft::AdCenter::V8::CampaignManagementService::Test::OperationError;
...
use Microsoft::AdCenter::V8::CampaignManagementService::OperationError;

sub test_can_create_operation_error_and_set_all_fields : Test(5) {
    my $operation_error = Microsoft::AdCenter::V8::CampaignManagementService::OperationError->new
        ->Code('code')
        ->Details('details')
