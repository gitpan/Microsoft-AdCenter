package Microsoft::AdCenter::V8::CampaignManagementService::Test::Step;
...
use Microsoft::AdCenter::V8::CampaignManagementService::Step;

sub test_can_create_step_and_set_all_fields : Test(6) {
    my $step = Microsoft::AdCenter::V8::CampaignManagementService::Step->new
        ->Id('id')
        ->Name('name')
