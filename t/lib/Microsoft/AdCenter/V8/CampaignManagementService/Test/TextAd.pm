package Microsoft::AdCenter::V8::CampaignManagementService::Test::TextAd;
...
use Microsoft::AdCenter::V8::CampaignManagementService::TextAd;

sub test_can_create_text_ad_and_set_all_fields : Test(5) {
    my $text_ad = Microsoft::AdCenter::V8::CampaignManagementService::TextAd->new
