package Microsoft::AdCenter::V8::CampaignManagementService::Test::Ad;
...
use Microsoft::AdCenter::V8::CampaignManagementService::Ad;

sub test_can_create_ad_and_set_all_fields : Test(5) {
    my $ad = Microsoft::AdCenter::V8::CampaignManagementService::Ad->new
