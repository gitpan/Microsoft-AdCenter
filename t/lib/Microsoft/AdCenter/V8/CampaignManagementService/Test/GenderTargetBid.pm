package Microsoft::AdCenter::V8::CampaignManagementService::Test::GenderTargetBid;
...
use Microsoft::AdCenter::V8::CampaignManagementService::GenderTargetBid;

sub test_can_create_gender_target_bid_and_set_all_fields : Test(3) {
    my $gender_target_bid = Microsoft::AdCenter::V8::CampaignManagementService::GenderTargetBid->new
        ->Gender('gender')
