package Microsoft::AdCenter::V8::CampaignManagementService::Test::GoalError;
...
use Microsoft::AdCenter::V8::CampaignManagementService::GoalError;

sub test_can_create_goal_error_and_set_all_fields : Test(4) {
    my $goal_error = Microsoft::AdCenter::V8::CampaignManagementService::GoalError->new
