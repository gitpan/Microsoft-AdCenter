package Microsoft::AdCenter::V8::OptimizerService::Test::BatchError;
...
use Microsoft::AdCenter::V8::OptimizerService::BatchError;

sub test_can_create_batch_error_and_set_all_fields : Test(6) {
    my $batch_error = Microsoft::AdCenter::V8::OptimizerService::BatchError->new
        ->Code('code')
        ->Details('details')
