package Microsoft::AdCenter::V8::AdministrationService::Test::GetAssignedQuotaResponse;
...
use Microsoft::AdCenter::V8::AdministrationService::GetAssignedQuotaResponse;

sub test_can_create_get_assigned_quota_response_and_set_all_fields : Test(2) {
    my $get_assigned_quota_response = Microsoft::AdCenter::V8::AdministrationService::GetAssignedQuotaResponse->new
