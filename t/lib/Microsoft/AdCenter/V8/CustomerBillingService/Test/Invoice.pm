package Microsoft::AdCenter::V8::CustomerBillingService::Test::Invoice;
...
use Microsoft::AdCenter::V8::CustomerBillingService::Invoice;

sub test_can_create_invoice_and_set_all_fields : Test(4) {
    my $invoice = Microsoft::AdCenter::V8::CustomerBillingService::Invoice->new
        ->Data('data')
        ->Id('id')
        ->Type('type')
    ;
