package Microsoft::AdCenter::V8::CustomerBillingService::Test::GetInsertionOrdersByAccountResponse;
...
use Microsoft::AdCenter::V8::CustomerBillingService::GetInsertionOrdersByAccountResponse;

sub test_can_create_get_insertion_orders_by_account_response_and_set_all_fields : Test(2) {
    my $get_insertion_orders_by_account_response = Microsoft::AdCenter::V8::CustomerBillingService::GetInsertionOrdersByAccountResponse->new
