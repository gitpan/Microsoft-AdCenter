package Microsoft::AdCenter::V8::NotificationService::Test::OperationError;
...
use Microsoft::AdCenter::V8::NotificationService::OperationError;

sub test_can_create_operation_error_and_set_all_fields : Test(4) {
    my $operation_error = Microsoft::AdCenter::V8::NotificationService::OperationError->new
        ->Code('code')
        ->Details('details')
        ->Message('message')
    ;
