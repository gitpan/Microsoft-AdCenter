package Microsoft::AdCenter::NotificationManagementService::Test::Notification;
...
use Microsoft::AdCenter::NotificationManagementService::Notification;

sub test_can_create_notification_and_set_all_fields : Test(6) {
    my $notification = Microsoft::AdCenter::NotificationManagementService::Notification->new
