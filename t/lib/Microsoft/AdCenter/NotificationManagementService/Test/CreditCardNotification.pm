package Microsoft::AdCenter::NotificationManagementService::Test::CreditCardNotification;
...
use Microsoft::AdCenter::NotificationManagementService::CreditCardNotification;

sub test_can_create_credit_card_notification_and_set_all_fields : Test(7) {
    my $credit_card_notification = Microsoft::AdCenter::NotificationManagementService::CreditCardNotification->new
