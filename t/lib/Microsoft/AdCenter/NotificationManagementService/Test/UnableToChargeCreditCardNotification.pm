package Microsoft::AdCenter::NotificationManagementService::Test::UnableToChargeCreditCardNotification;
...
use Microsoft::AdCenter::NotificationManagementService::UnableToChargeCreditCardNotification;

sub test_can_create_unable_to_charge_credit_card_notification_and_set_all_fields : Test(8) {
    my $unable_to_charge_credit_card_notification = Microsoft::AdCenter::NotificationManagementService::UnableToChargeCreditCardNotification->new
