package Microsoft::AdCenter::SecureDataManagementService::Test::OperationError;
...
use Microsoft::AdCenter::SecureDataManagementService::OperationError;

sub test_can_create_operation_error_and_set_all_fields : Test(4) {
    my $operation_error = Microsoft::AdCenter::SecureDataManagementService::OperationError->new
        ->Code('code')
        ->Details('details')
        ->Message('message')
    ;
