package Microsoft::AdCenter::V6::CampaignManagementService::Test::KeywordEstimate;
...
use Microsoft::AdCenter::V6::CampaignManagementService::KeywordEstimate;

sub test_can_create_keyword_estimate_and_set_all_fields : Test(7) {
    my $keyword_estimate = Microsoft::AdCenter::V6::CampaignManagementService::KeywordEstimate->new
