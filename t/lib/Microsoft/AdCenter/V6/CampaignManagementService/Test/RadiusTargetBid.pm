package Microsoft::AdCenter::V6::CampaignManagementService::Test::RadiusTargetBid;
...
use Microsoft::AdCenter::V6::CampaignManagementService::RadiusTargetBid;

sub test_can_create_radius_target_bid_and_set_all_fields : Test(5) {
    my $radius_target_bid = Microsoft::AdCenter::V6::CampaignManagementService::RadiusTargetBid->new
