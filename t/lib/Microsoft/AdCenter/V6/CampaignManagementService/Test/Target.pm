package Microsoft::AdCenter::V6::CampaignManagementService::Test::Target;
...
use Microsoft::AdCenter::V6::CampaignManagementService::Target;

sub test_can_create_target_and_set_all_fields : Test(11) {
    my $target = Microsoft::AdCenter::V6::CampaignManagementService::Target->new
        ->Age('age')
        ->Behavior('behavior')
        ->Day('day')
        ->Gender('gender')
