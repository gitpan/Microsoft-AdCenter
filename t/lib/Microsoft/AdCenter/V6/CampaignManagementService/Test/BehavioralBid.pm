package Microsoft::AdCenter::V6::CampaignManagementService::Test::BehavioralBid;
...
use Microsoft::AdCenter::V6::CampaignManagementService::BehavioralBid;

sub test_can_create_behavioral_bid_and_set_all_fields : Test(6) {
    my $behavioral_bid = Microsoft::AdCenter::V6::CampaignManagementService::BehavioralBid->new
        ->Bid('bid')
        ->Id('id')
        ->Name('name')
