package Microsoft::AdCenter::V6::CampaignManagementService::Test::BusinessTargetBid;
...
use Microsoft::AdCenter::V6::CampaignManagementService::BusinessTargetBid;

sub test_can_create_business_target_bid_and_set_all_fields : Test(4) {
    my $business_target_bid = Microsoft::AdCenter::V6::CampaignManagementService::BusinessTargetBid->new
