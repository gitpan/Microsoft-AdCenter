package Microsoft::AdCenter::V6::CampaignManagementService::Test::CampaignNegativeKeywords;
...
use Microsoft::AdCenter::V6::CampaignManagementService::CampaignNegativeKeywords;

sub test_can_create_campaign_negative_keywords_and_set_all_fields : Test(3) {
    my $campaign_negative_keywords = Microsoft::AdCenter::V6::CampaignManagementService::CampaignNegativeKeywords->new
