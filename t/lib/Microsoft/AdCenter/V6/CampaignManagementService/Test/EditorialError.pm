package Microsoft::AdCenter::V6::CampaignManagementService::Test::EditorialError;
...
use Microsoft::AdCenter::V6::CampaignManagementService::EditorialError;

sub test_can_create_editorial_error_and_set_all_fields : Test(7) {
    my $editorial_error = Microsoft::AdCenter::V6::CampaignManagementService::EditorialError->new
