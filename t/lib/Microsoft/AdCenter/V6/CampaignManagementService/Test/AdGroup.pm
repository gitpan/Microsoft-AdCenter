package Microsoft::AdCenter::V6::CampaignManagementService::Test::AdGroup;
...
use Microsoft::AdCenter::V6::CampaignManagementService::AdGroup;

sub test_can_create_ad_group_and_set_all_fields : Test(17) {
    my $ad_group = Microsoft::AdCenter::V6::CampaignManagementService::AdGroup->new
