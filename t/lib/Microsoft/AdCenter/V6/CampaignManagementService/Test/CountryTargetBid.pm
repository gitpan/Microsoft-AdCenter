package Microsoft::AdCenter::V6::CampaignManagementService::Test::CountryTargetBid;
...
use Microsoft::AdCenter::V6::CampaignManagementService::CountryTargetBid;

sub test_can_create_country_target_bid_and_set_all_fields : Test(3) {
    my $country_target_bid = Microsoft::AdCenter::V6::CampaignManagementService::CountryTargetBid->new
