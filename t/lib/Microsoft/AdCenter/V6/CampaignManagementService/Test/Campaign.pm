package Microsoft::AdCenter::V6::CampaignManagementService::Test::Campaign;
...
use Microsoft::AdCenter::V6::CampaignManagementService::Campaign;

sub test_can_create_campaign_and_set_all_fields : Test(15) {
    my $campaign = Microsoft::AdCenter::V6::CampaignManagementService::Campaign->new
