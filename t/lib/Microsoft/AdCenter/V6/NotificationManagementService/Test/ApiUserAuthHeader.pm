package Microsoft::AdCenter::V6::NotificationManagementService::Test::ApiUserAuthHeader;
...
use Microsoft::AdCenter::V6::NotificationManagementService::ApiUserAuthHeader;

sub test_can_create_api_user_auth_header_and_set_all_fields : Test(4) {
    my $api_user_auth_header = Microsoft::AdCenter::V6::NotificationManagementService::ApiUserAuthHeader->new
        ->Password('password')
