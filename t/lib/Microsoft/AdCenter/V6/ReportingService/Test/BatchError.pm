package Microsoft::AdCenter::V6::ReportingService::Test::BatchError;
...
use Microsoft::AdCenter::V6::ReportingService::BatchError;

sub test_can_create_batch_error_and_set_all_fields : Test(6) {
    my $batch_error = Microsoft::AdCenter::V6::ReportingService::BatchError->new
        ->Code('code')
        ->Details('details')
