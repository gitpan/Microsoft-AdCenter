package Microsoft::AdCenter::V6::ReportingService::Test::AccountThroughCampaignReportScope;
...
use Microsoft::AdCenter::V6::ReportingService::AccountThroughCampaignReportScope;

sub test_can_create_account_through_campaign_report_scope_and_set_all_fields : Test(3) {
    my $account_through_campaign_report_scope = Microsoft::AdCenter::V6::ReportingService::AccountThroughCampaignReportScope->new
