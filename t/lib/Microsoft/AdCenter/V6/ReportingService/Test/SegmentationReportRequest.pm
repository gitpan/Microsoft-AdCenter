package Microsoft::AdCenter::V6::ReportingService::Test::SegmentationReportRequest;
...
use Microsoft::AdCenter::V6::ReportingService::SegmentationReportRequest;

sub test_can_create_segmentation_report_request_and_set_all_fields : Test(6) {
    my $segmentation_report_request = Microsoft::AdCenter::V6::ReportingService::SegmentationReportRequest->new
