package Microsoft::AdCenter::V6::ReportingService::Test::Date;
...
use Microsoft::AdCenter::V6::ReportingService::Date;

sub test_can_create_date_and_set_all_fields : Test(4) {
    my $date = Microsoft::AdCenter::V6::ReportingService::Date->new
        ->Day('day')
        ->Month('month')
        ->Year('year')
    ;
