package Microsoft::AdCenter::V6::ReportingService::Test::CampaignReportScope;
...
use Microsoft::AdCenter::V6::ReportingService::CampaignReportScope;

sub test_can_create_campaign_report_scope_and_set_all_fields : Test(3) {
    my $campaign_report_scope = Microsoft::AdCenter::V6::ReportingService::CampaignReportScope->new
