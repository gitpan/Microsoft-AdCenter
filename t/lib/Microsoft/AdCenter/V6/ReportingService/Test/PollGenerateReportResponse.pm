package Microsoft::AdCenter::V6::ReportingService::Test::PollGenerateReportResponse;
...
use Microsoft::AdCenter::V6::ReportingService::PollGenerateReportResponse;

sub test_can_create_poll_generate_report_response_and_set_all_fields : Test(2) {
    my $poll_generate_report_response = Microsoft::AdCenter::V6::ReportingService::PollGenerateReportResponse->new
