package Microsoft::AdCenter::V6::ReportingService::Test::DestinationUrlPerformanceReportRequest;
...
use Microsoft::AdCenter::V6::ReportingService::DestinationUrlPerformanceReportRequest;

sub test_can_create_destination_url_performance_report_request_and_set_all_fields : Test(6) {
    my $destination_url_performance_report_request = Microsoft::AdCenter::V6::ReportingService::DestinationUrlPerformanceReportRequest->new
