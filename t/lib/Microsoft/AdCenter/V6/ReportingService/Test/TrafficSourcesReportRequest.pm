package Microsoft::AdCenter::V6::ReportingService::Test::TrafficSourcesReportRequest;
...
use Microsoft::AdCenter::V6::ReportingService::TrafficSourcesReportRequest;

sub test_can_create_traffic_sources_report_request_and_set_all_fields : Test(6) {
    my $traffic_sources_report_request = Microsoft::AdCenter::V6::ReportingService::TrafficSourcesReportRequest->new
