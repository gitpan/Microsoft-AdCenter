package Microsoft::AdCenter::V6::ReportingService::Test::CampaignPerformanceReportRequest;
...
use Microsoft::AdCenter::V6::ReportingService::CampaignPerformanceReportRequest;

sub test_can_create_campaign_performance_report_request_and_set_all_fields : Test(6) {
    my $campaign_performance_report_request = Microsoft::AdCenter::V6::ReportingService::CampaignPerformanceReportRequest->new
