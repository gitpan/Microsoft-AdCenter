package Microsoft::AdCenter::V6::ReportingService::Test::AccountThroughAdGroupReportScope;
...
use Microsoft::AdCenter::V6::ReportingService::AccountThroughAdGroupReportScope;

sub test_can_create_account_through_ad_group_report_scope_and_set_all_fields : Test(4) {
    my $account_through_ad_group_report_scope = Microsoft::AdCenter::V6::ReportingService::AccountThroughAdGroupReportScope->new
