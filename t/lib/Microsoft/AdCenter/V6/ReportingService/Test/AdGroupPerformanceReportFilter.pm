package Microsoft::AdCenter::V6::ReportingService::Test::AdGroupPerformanceReportFilter;
...
use Microsoft::AdCenter::V6::ReportingService::AdGroupPerformanceReportFilter;

sub test_can_create_ad_group_performance_report_filter_and_set_all_fields : Test(5) {
    my $ad_group_performance_report_filter = Microsoft::AdCenter::V6::ReportingService::AdGroupPerformanceReportFilter->new
