package Microsoft::AdCenter::V6::ReportingService::Test::BudgetSummaryReportRequest;
...
use Microsoft::AdCenter::V6::ReportingService::BudgetSummaryReportRequest;

sub test_can_create_budget_summary_report_request_and_set_all_fields : Test(4) {
    my $budget_summary_report_request = Microsoft::AdCenter::V6::ReportingService::BudgetSummaryReportRequest->new
        ->Columns('columns')
        ->Scope('scope')
        ->Time('time')
    ;
