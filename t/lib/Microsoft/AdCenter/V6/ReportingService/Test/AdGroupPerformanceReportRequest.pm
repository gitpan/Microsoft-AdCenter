package Microsoft::AdCenter::V6::ReportingService::Test::AdGroupPerformanceReportRequest;
...
use Microsoft::AdCenter::V6::ReportingService::AdGroupPerformanceReportRequest;

sub test_can_create_ad_group_performance_report_request_and_set_all_fields : Test(6) {
    my $ad_group_performance_report_request = Microsoft::AdCenter::V6::ReportingService::AdGroupPerformanceReportRequest->new
