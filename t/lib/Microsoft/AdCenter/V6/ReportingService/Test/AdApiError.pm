package Microsoft::AdCenter::V6::ReportingService::Test::AdApiError;
...
use Microsoft::AdCenter::V6::ReportingService::AdApiError;

sub test_can_create_ad_api_error_and_set_all_fields : Test(5) {
    my $ad_api_error = Microsoft::AdCenter::V6::ReportingService::AdApiError->new
        ->Code('code')
        ->Detail('detail')
