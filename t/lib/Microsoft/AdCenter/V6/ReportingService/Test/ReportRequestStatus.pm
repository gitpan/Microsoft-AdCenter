package Microsoft::AdCenter::V6::ReportingService::Test::ReportRequestStatus;
...
use Microsoft::AdCenter::V6::ReportingService::ReportRequestStatus;

sub test_can_create_report_request_status_and_set_all_fields : Test(3) {
    my $report_request_status = Microsoft::AdCenter::V6::ReportingService::ReportRequestStatus->new
