package Microsoft::AdCenter::V6::ReportingService::Test::BehavioralTargetReportFilter;
...
use Microsoft::AdCenter::V6::ReportingService::BehavioralTargetReportFilter;

sub test_can_create_behavioral_target_report_filter_and_set_all_fields : Test(4) {
    my $behavioral_target_report_filter = Microsoft::AdCenter::V6::ReportingService::BehavioralTargetReportFilter->new
