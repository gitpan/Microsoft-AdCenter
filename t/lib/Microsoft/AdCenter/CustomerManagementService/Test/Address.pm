package Microsoft::AdCenter::CustomerManagementService::Test::Address;
...
use Microsoft::AdCenter::CustomerManagementService::Address;

sub test_can_create_address_and_set_all_fields : Test(11) {
    my $address = Microsoft::AdCenter::CustomerManagementService::Address->new
        ->City('city')
