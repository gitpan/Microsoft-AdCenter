package Microsoft::AdCenter::CustomerManagementService::Test::PersonName;
...
use Microsoft::AdCenter::CustomerManagementService::PersonName;

sub test_can_create_person_name_and_set_all_fields : Test(4) {
    my $person_name = Microsoft::AdCenter::CustomerManagementService::PersonName->new
