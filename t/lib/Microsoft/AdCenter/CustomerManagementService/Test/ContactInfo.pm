package Microsoft::AdCenter::CustomerManagementService::Test::ContactInfo;
...
use Microsoft::AdCenter::CustomerManagementService::ContactInfo;

sub test_can_create_contact_info_and_set_all_fields : Test(12) {
    my $contact_info = Microsoft::AdCenter::CustomerManagementService::ContactInfo->new
        ->Address('address')
