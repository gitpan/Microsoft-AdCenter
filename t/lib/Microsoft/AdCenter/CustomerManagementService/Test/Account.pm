package Microsoft::AdCenter::CustomerManagementService::Test::Account;
...
use Microsoft::AdCenter::CustomerManagementService::Account;

sub test_can_create_account_and_set_all_fields : Test(19) {
    my $account = Microsoft::AdCenter::CustomerManagementService::Account->new
