package Microsoft::AdCenter::CustomerBillingService::Test::OperationError;
...
use Microsoft::AdCenter::CustomerBillingService::OperationError;

sub test_can_create_operation_error_and_set_all_fields : Test(4) {
    my $operation_error = Microsoft::AdCenter::CustomerBillingService::OperationError->new
        ->Code('code')
        ->Details('details')
        ->Message('message')
    ;
