package Microsoft::AdCenter::CustomerBillingService::Test::ApiFault;
...
use Microsoft::AdCenter::CustomerBillingService::ApiFault;

sub test_can_create_api_fault_and_set_all_fields : Test(2) {
    my $api_fault = Microsoft::AdCenter::CustomerBillingService::ApiFault->new
