package Microsoft::AdCenter::CustomerBillingService::Test::AdApiError;
...
use Microsoft::AdCenter::CustomerBillingService::AdApiError;

sub test_can_create_ad_api_error_and_set_all_fields : Test(5) {
    my $ad_api_error = Microsoft::AdCenter::CustomerBillingService::AdApiError->new
        ->Code('code')
        ->Detail('detail')
