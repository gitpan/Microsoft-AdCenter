package Microsoft::AdCenter::V7::CustomerManagementService::Test::UpdateUserResponse;
...
use Microsoft::AdCenter::V7::CustomerManagementService::UpdateUserResponse;

sub test_can_create_update_user_response_and_set_all_fields : Test(2) {
    my $update_user_response = Microsoft::AdCenter::V7::CustomerManagementService::UpdateUserResponse->new
