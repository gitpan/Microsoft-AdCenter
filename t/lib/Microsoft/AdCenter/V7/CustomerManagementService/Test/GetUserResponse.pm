package Microsoft::AdCenter::V7::CustomerManagementService::Test::GetUserResponse;
...
use Microsoft::AdCenter::V7::CustomerManagementService::GetUserResponse;

sub test_can_create_get_user_response_and_set_all_fields : Test(5) {
    my $get_user_response = Microsoft::AdCenter::V7::CustomerManagementService::GetUserResponse->new
        ->Accounts('accounts')
        ->Customers('customers')
        ->Roles('roles')
        ->User('user')
