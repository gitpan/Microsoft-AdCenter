package Microsoft::AdCenter::V7::CustomerManagementService::Test::GetCustomerPilotFeatureResponse;
...
use Microsoft::AdCenter::V7::CustomerManagementService::GetCustomerPilotFeatureResponse;

sub test_can_create_get_customer_pilot_feature_response_and_set_all_fields : Test(2) {
    my $get_customer_pilot_feature_response = Microsoft::AdCenter::V7::CustomerManagementService::GetCustomerPilotFeatureResponse->new
