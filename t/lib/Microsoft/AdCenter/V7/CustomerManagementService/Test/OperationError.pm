package Microsoft::AdCenter::V7::CustomerManagementService::Test::OperationError;
...
use Microsoft::AdCenter::V7::CustomerManagementService::OperationError;

sub test_can_create_operation_error_and_set_all_fields : Test(4) {
    my $operation_error = Microsoft::AdCenter::V7::CustomerManagementService::OperationError->new
        ->Code('code')
        ->Details('details')
        ->Message('message')
    ;
