package Microsoft::AdCenter::V7::ReportingService::Test::MetroAreaDemographicReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::MetroAreaDemographicReportFilter;

sub test_can_create_metro_area_demographic_report_filter_and_set_all_fields : Test(4) {
    my $metro_area_demographic_report_filter = Microsoft::AdCenter::V7::ReportingService::MetroAreaDemographicReportFilter->new
