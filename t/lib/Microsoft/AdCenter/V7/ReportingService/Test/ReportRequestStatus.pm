package Microsoft::AdCenter::V7::ReportingService::Test::ReportRequestStatus;
...
use Microsoft::AdCenter::V7::ReportingService::ReportRequestStatus;

sub test_can_create_report_request_status_and_set_all_fields : Test(3) {
    my $report_request_status = Microsoft::AdCenter::V7::ReportingService::ReportRequestStatus->new
