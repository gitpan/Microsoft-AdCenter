package Microsoft::AdCenter::V7::ReportingService::Test::KeywordPerformanceReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::KeywordPerformanceReportRequest;

sub test_can_create_keyword_performance_report_request_and_set_all_fields : Test(6) {
    my $keyword_performance_report_request = Microsoft::AdCenter::V7::ReportingService::KeywordPerformanceReportRequest->new
