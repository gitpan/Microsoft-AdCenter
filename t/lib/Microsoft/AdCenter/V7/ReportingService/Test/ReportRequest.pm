package Microsoft::AdCenter::V7::ReportingService::Test::ReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::ReportRequest;

sub test_can_create_report_request_and_set_all_fields : Test(5) {
    my $report_request = Microsoft::AdCenter::V7::ReportingService::ReportRequest->new
        ->Format('format')
        ->Language('language')
