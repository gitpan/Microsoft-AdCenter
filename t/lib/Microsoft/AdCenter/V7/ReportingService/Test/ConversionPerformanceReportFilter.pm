package Microsoft::AdCenter::V7::ReportingService::Test::ConversionPerformanceReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::ConversionPerformanceReportFilter;

sub test_can_create_conversion_performance_report_filter_and_set_all_fields : Test(3) {
    my $conversion_performance_report_filter = Microsoft::AdCenter::V7::ReportingService::ConversionPerformanceReportFilter->new
