package Microsoft::AdCenter::V7::ReportingService::Test::AgeGenderDemographicReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::AgeGenderDemographicReportFilter;

sub test_can_create_age_gender_demographic_report_filter_and_set_all_fields : Test(3) {
    my $age_gender_demographic_report_filter = Microsoft::AdCenter::V7::ReportingService::AgeGenderDemographicReportFilter->new
