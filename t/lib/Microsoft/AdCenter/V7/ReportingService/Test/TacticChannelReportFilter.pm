package Microsoft::AdCenter::V7::ReportingService::Test::TacticChannelReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::TacticChannelReportFilter;

sub test_can_create_tactic_channel_report_filter_and_set_all_fields : Test(5) {
    my $tactic_channel_report_filter = Microsoft::AdCenter::V7::ReportingService::TacticChannelReportFilter->new
