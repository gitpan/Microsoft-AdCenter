package Microsoft::AdCenter::V7::ReportingService::Test::SegmentationReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::SegmentationReportFilter;

sub test_can_create_segmentation_report_filter_and_set_all_fields : Test(6) {
    my $segmentation_report_filter = Microsoft::AdCenter::V7::ReportingService::SegmentationReportFilter->new
        ->AgeGroup('age group')
        ->Country('country')
        ->Gender('gender')
        ->GoalIds('goal ids')
