package Microsoft::AdCenter::V7::ReportingService::Test::BehavioralTargetReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::BehavioralTargetReportRequest;

sub test_can_create_behavioral_target_report_request_and_set_all_fields : Test(6) {
    my $behavioral_target_report_request = Microsoft::AdCenter::V7::ReportingService::BehavioralTargetReportRequest->new
