package Microsoft::AdCenter::V7::ReportingService::Test::BehavioralPerformanceReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::BehavioralPerformanceReportRequest;

sub test_can_create_behavioral_performance_report_request_and_set_all_fields : Test(6) {
    my $behavioral_performance_report_request = Microsoft::AdCenter::V7::ReportingService::BehavioralPerformanceReportRequest->new
