package Microsoft::AdCenter::V7::ReportingService::Test::AccountPerformanceReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::AccountPerformanceReportFilter;

sub test_can_create_account_performance_report_filter_and_set_all_fields : Test(3) {
    my $account_performance_report_filter = Microsoft::AdCenter::V7::ReportingService::AccountPerformanceReportFilter->new
