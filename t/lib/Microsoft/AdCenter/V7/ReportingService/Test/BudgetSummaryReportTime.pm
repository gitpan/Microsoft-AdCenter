package Microsoft::AdCenter::V7::ReportingService::Test::BudgetSummaryReportTime;
...
use Microsoft::AdCenter::V7::ReportingService::BudgetSummaryReportTime;

sub test_can_create_budget_summary_report_time_and_set_all_fields : Test(4) {
    my $budget_summary_report_time = Microsoft::AdCenter::V7::ReportingService::BudgetSummaryReportTime->new
