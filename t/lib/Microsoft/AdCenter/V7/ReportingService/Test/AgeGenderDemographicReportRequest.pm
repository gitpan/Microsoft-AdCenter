package Microsoft::AdCenter::V7::ReportingService::Test::AgeGenderDemographicReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::AgeGenderDemographicReportRequest;

sub test_can_create_age_gender_demographic_report_request_and_set_all_fields : Test(6) {
    my $age_gender_demographic_report_request = Microsoft::AdCenter::V7::ReportingService::AgeGenderDemographicReportRequest->new
