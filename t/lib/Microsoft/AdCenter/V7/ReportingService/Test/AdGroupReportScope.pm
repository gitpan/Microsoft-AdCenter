package Microsoft::AdCenter::V7::ReportingService::Test::AdGroupReportScope;
...
use Microsoft::AdCenter::V7::ReportingService::AdGroupReportScope;

sub test_can_create_ad_group_report_scope_and_set_all_fields : Test(4) {
    my $ad_group_report_scope = Microsoft::AdCenter::V7::ReportingService::AdGroupReportScope->new
