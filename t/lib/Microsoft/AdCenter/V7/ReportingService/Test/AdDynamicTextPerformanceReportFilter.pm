package Microsoft::AdCenter::V7::ReportingService::Test::AdDynamicTextPerformanceReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::AdDynamicTextPerformanceReportFilter;

sub test_can_create_ad_dynamic_text_performance_report_filter_and_set_all_fields : Test(5) {
    my $ad_dynamic_text_performance_report_filter = Microsoft::AdCenter::V7::ReportingService::AdDynamicTextPerformanceReportFilter->new
