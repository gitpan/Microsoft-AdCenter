package Microsoft::AdCenter::V7::ReportingService::Test::ConversionPerformanceReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::ConversionPerformanceReportRequest;

sub test_can_create_conversion_performance_report_request_and_set_all_fields : Test(6) {
    my $conversion_performance_report_request = Microsoft::AdCenter::V7::ReportingService::ConversionPerformanceReportRequest->new
