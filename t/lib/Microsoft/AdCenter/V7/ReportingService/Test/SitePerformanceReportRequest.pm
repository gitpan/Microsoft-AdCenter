package Microsoft::AdCenter::V7::ReportingService::Test::SitePerformanceReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::SitePerformanceReportRequest;

sub test_can_create_site_performance_report_request_and_set_all_fields : Test(6) {
    my $site_performance_report_request = Microsoft::AdCenter::V7::ReportingService::SitePerformanceReportRequest->new
