package Microsoft::AdCenter::V7::ReportingService::Test::CampaignPerformanceReportFilter;
...
use Microsoft::AdCenter::V7::ReportingService::CampaignPerformanceReportFilter;

sub test_can_create_campaign_performance_report_filter_and_set_all_fields : Test(4) {
    my $campaign_performance_report_filter = Microsoft::AdCenter::V7::ReportingService::CampaignPerformanceReportFilter->new
