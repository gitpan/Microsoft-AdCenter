package Microsoft::AdCenter::V7::CustomerBillingService::Test::UpdateInsertionOrderResponse;
...
use Microsoft::AdCenter::V7::CustomerBillingService::UpdateInsertionOrderResponse;

sub test_can_create_update_insertion_order_response_and_set_all_fields : Test(2) {
    my $update_insertion_order_response = Microsoft::AdCenter::V7::CustomerBillingService::UpdateInsertionOrderResponse->new
