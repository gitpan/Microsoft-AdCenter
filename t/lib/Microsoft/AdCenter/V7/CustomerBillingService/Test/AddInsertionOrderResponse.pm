package Microsoft::AdCenter::V7::CustomerBillingService::Test::AddInsertionOrderResponse;
...
use Microsoft::AdCenter::V7::CustomerBillingService::AddInsertionOrderResponse;

sub test_can_create_add_insertion_order_response_and_set_all_fields : Test(3) {
    my $add_insertion_order_response = Microsoft::AdCenter::V7::CustomerBillingService::AddInsertionOrderResponse->new
