package Microsoft::AdCenter::V7::CampaignManagementService::Test::MetroAreaTargetBid;
...
use Microsoft::AdCenter::V7::CampaignManagementService::MetroAreaTargetBid;

sub test_can_create_metro_area_target_bid_and_set_all_fields : Test(3) {
    my $metro_area_target_bid = Microsoft::AdCenter::V7::CampaignManagementService::MetroAreaTargetBid->new
