package Microsoft::AdCenter::V7::CampaignManagementService::Test::MobileAd;
...
use Microsoft::AdCenter::V7::CampaignManagementService::MobileAd;

sub test_can_create_mobile_ad_and_set_all_fields : Test(7) {
    my $mobile_ad = Microsoft::AdCenter::V7::CampaignManagementService::MobileAd->new
