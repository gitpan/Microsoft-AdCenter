package Microsoft::AdCenter::V7::CampaignManagementService::Test::EditorialApiFaultDetail;
...
use Microsoft::AdCenter::V7::CampaignManagementService::EditorialApiFaultDetail;

sub test_can_create_editorial_api_fault_detail_and_set_all_fields : Test(4) {
    my $editorial_api_fault_detail = Microsoft::AdCenter::V7::CampaignManagementService::EditorialApiFaultDetail->new
