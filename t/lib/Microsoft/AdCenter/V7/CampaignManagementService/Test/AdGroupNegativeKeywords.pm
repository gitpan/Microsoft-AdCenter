package Microsoft::AdCenter::V7::CampaignManagementService::Test::AdGroupNegativeKeywords;
...
use Microsoft::AdCenter::V7::CampaignManagementService::AdGroupNegativeKeywords;

sub test_can_create_ad_group_negative_keywords_and_set_all_fields : Test(3) {
    my $ad_group_negative_keywords = Microsoft::AdCenter::V7::CampaignManagementService::AdGroupNegativeKeywords->new
