package Microsoft::AdCenter::V7::CampaignManagementService::Test::LocationTarget;
...
use Microsoft::AdCenter::V7::CampaignManagementService::LocationTarget;

sub test_can_create_location_target_and_set_all_fields : Test(8) {
    my $location_target = Microsoft::AdCenter::V7::CampaignManagementService::LocationTarget->new
