package Microsoft::AdCenter::V7::CampaignManagementService::Test::CashBackInfo;
...
use Microsoft::AdCenter::V7::CampaignManagementService::CashBackInfo;

sub test_can_create_cash_back_info_and_set_all_fields : Test(4) {
    my $cash_back_info = Microsoft::AdCenter::V7::CampaignManagementService::CashBackInfo->new
