package Microsoft::AdCenter::V7::CampaignManagementService::Test::AnalyticsApiFaultDetail;
...
use Microsoft::AdCenter::V7::CampaignManagementService::AnalyticsApiFaultDetail;

sub test_can_create_analytics_api_fault_detail_and_set_all_fields : Test(3) {
    my $analytics_api_fault_detail = Microsoft::AdCenter::V7::CampaignManagementService::AnalyticsApiFaultDetail->new
