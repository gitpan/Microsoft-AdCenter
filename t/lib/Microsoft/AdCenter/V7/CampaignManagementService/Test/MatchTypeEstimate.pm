package Microsoft::AdCenter::V7::CampaignManagementService::Test::MatchTypeEstimate;
...
use Microsoft::AdCenter::V7::CampaignManagementService::MatchTypeEstimate;

sub test_can_create_match_type_estimate_and_set_all_fields : Test(4) {
    my $match_type_estimate = Microsoft::AdCenter::V7::CampaignManagementService::MatchTypeEstimate->new
