package Microsoft::AdCenter::V7::CampaignManagementService::Test::SitePlacement;
...
use Microsoft::AdCenter::V7::CampaignManagementService::SitePlacement;

sub test_can_create_site_placement_and_set_all_fields : Test(6) {
    my $site_placement = Microsoft::AdCenter::V7::CampaignManagementService::SitePlacement->new
        ->Bid('bid')
        ->Id('id')
