package Microsoft::AdCenter::V7::CampaignManagementService::Test::HoursOfOperation;
...
use Microsoft::AdCenter::V7::CampaignManagementService::HoursOfOperation;

sub test_can_create_hours_of_operation_and_set_all_fields : Test(4) {
    my $hours_of_operation = Microsoft::AdCenter::V7::CampaignManagementService::HoursOfOperation->new
        ->Day('day')
