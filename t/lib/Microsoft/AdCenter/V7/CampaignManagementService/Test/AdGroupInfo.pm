package Microsoft::AdCenter::V7::CampaignManagementService::Test::AdGroupInfo;
...
use Microsoft::AdCenter::V7::CampaignManagementService::AdGroupInfo;

sub test_can_create_ad_group_info_and_set_all_fields : Test(15) {
    my $ad_group_info = Microsoft::AdCenter::V7::CampaignManagementService::AdGroupInfo->new
