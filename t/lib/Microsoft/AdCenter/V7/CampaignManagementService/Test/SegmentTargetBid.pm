package Microsoft::AdCenter::V7::CampaignManagementService::Test::SegmentTargetBid;
...
use Microsoft::AdCenter::V7::CampaignManagementService::SegmentTargetBid;

sub test_can_create_segment_target_bid_and_set_all_fields : Test(9) {
    my $segment_target_bid = Microsoft::AdCenter::V7::CampaignManagementService::SegmentTargetBid->new
