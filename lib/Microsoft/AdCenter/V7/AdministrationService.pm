package Microsoft::AdCenter::V7::AdministrationService;
...
Microsoft::AdCenter::V7::AdministrationService - Service client for Microsoft AdCenter Administration Service.

=head1 SYNOPSIS

    use Microsoft::AdCenter::V7::AdministrationService;

    my $service_client = Microsoft::AdCenter::V7::AdministrationService->new
