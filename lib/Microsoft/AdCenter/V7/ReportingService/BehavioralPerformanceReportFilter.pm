package Microsoft::AdCenter::V7::ReportingService::BehavioralPerformanceReportFilter;
...
Microsoft::AdCenter::V7::ReportingService::BehavioralPerformanceReportFilter - Represents "BehavioralPerformanceReportFilter" in Microsoft AdCenter Reporting Service.

=cut

sub _type_name {
    return 'BehavioralPerformanceReportFilter';
}
...
Gets/sets BehavioralIds (ArrayOflong)
