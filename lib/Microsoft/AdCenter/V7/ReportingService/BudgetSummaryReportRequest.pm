package Microsoft::AdCenter::V7::ReportingService::BudgetSummaryReportRequest;
...
Microsoft::AdCenter::V7::ReportingService::BudgetSummaryReportRequest - Represents "BudgetSummaryReportRequest" in Microsoft AdCenter Reporting Service.
