package Microsoft::AdCenter::V7::ReportingService::ReportRequestStatus;
...
Microsoft::AdCenter::V7::ReportingService::ReportRequestStatus - Represents "ReportRequestStatus" in Microsoft AdCenter Reporting Service.
