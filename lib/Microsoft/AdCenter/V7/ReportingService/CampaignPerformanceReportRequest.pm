package Microsoft::AdCenter::V7::ReportingService::CampaignPerformanceReportRequest;
...
Microsoft::AdCenter::V7::ReportingService::CampaignPerformanceReportRequest - Represents "CampaignPerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
Gets/sets Columns (ArrayOfCampaignPerformanceReportColumn)

=head2 Filter

Gets/sets Filter (CampaignPerformanceReportFilter)

=head2 Scope

Gets/sets Scope (AccountThroughCampaignReportScope)
