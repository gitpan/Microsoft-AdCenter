package Microsoft::AdCenter::V7::ReportingService::TacticChannelReportRequest;
...
Microsoft::AdCenter::V7::ReportingService::TacticChannelReportRequest - Represents "TacticChannelReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'TacticChannelReportRequest';
}
...
Gets/sets Columns (ArrayOfTacticChannelReportColumn)

=head2 Filter

Gets/sets Filter (TacticChannelReportFilter)
