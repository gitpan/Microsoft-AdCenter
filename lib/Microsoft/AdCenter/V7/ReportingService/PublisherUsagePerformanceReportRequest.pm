package Microsoft::AdCenter::V7::ReportingService::PublisherUsagePerformanceReportRequest;
...
Microsoft::AdCenter::V7::ReportingService::PublisherUsagePerformanceReportRequest - Represents "PublisherUsagePerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'PublisherUsagePerformanceReportRequest';
}
...
Gets/sets Columns (ArrayOfPublisherUsagePerformanceReportColumn)

=head2 Filter

Gets/sets Filter (PublisherUsagePerformanceReportFilter)
