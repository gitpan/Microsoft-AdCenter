package Microsoft::AdCenter::V7::CampaignManagementService::Network;
...
Microsoft::AdCenter::V7::CampaignManagementService::Network - Represents "Network" in Microsoft AdCenter Campaign Management Service.
