package Microsoft::AdCenter::AdIntelligenceService;
...
Microsoft::AdCenter::AdIntelligenceService - Service client for Microsoft AdCenter Ad Intelligence Service.

=head1 SYNOPSIS

    use Microsoft::AdCenter::AdIntelligenceService;

    my $service_client = Microsoft::AdCenter::AdIntelligenceService->new
...
sub _default_location {
    return 'https://api.si.adcenter.microsoft.com/Api/Advertiser/V8/CampaignManagement/AdIntelligenceService.svc';
}

sub _wsdl {
    return 'https://api.si.adcenter.microsoft.com/Api/Advertiser/V8/CampaignManagement/AdIntelligenceService.svc?wsdl';
}
