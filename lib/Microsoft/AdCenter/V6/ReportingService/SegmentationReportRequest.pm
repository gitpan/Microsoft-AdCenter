package Microsoft::AdCenter::V6::ReportingService::SegmentationReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::SegmentationReportRequest - Represents "SegmentationReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'SegmentationReportRequest';
}
...
Gets/sets Columns (ArrayOfSegmentationReportColumn)

=head2 Filter

Gets/sets Filter (SegmentationReportFilter)
