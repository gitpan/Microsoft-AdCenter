package Microsoft::AdCenter::V6::ReportingService::BehavioralTargetReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::BehavioralTargetReportRequest - Represents "BehavioralTargetReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'BehavioralTargetReportRequest';
}
...
Gets/sets Columns (ArrayOfBehavioralTargetReportColumn)

=head2 Filter

Gets/sets Filter (BehavioralTargetReportFilter)
