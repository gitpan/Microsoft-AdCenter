package Microsoft::AdCenter::V6::ReportingService::BudgetSummaryReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::BudgetSummaryReportRequest - Represents "BudgetSummaryReportRequest" in Microsoft AdCenter Reporting Service.
...
Gets/sets Columns (ArrayOfBudgetSummaryReportColumn)
...
Gets/sets Time (BudgetSummaryReportTime)
