package Microsoft::AdCenter::V6::ReportingService::AccountPerformanceReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::AccountPerformanceReportRequest - Represents "AccountPerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
Gets/sets Columns (ArrayOfAccountPerformanceReportColumn)

=head2 Filter

Gets/sets Filter (AccountPerformanceReportFilter)
