package Microsoft::AdCenter::V6::ReportingService::BehavioralTargetReportFilter;
...
Microsoft::AdCenter::V6::ReportingService::BehavioralTargetReportFilter - Represents "BehavioralTargetReportFilter" in Microsoft AdCenter Reporting Service.

=cut

sub _type_name {
    return 'BehavioralTargetReportFilter';
}
