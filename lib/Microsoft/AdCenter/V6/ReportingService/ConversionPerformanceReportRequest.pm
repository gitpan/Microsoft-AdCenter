package Microsoft::AdCenter::V6::ReportingService::ConversionPerformanceReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::ConversionPerformanceReportRequest - Represents "ConversionPerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'ConversionPerformanceReportRequest';
}
...
Gets/sets Columns (ArrayOfConversionPerformanceReportColumn)

=head2 Filter

Gets/sets Filter (ConversionPerformanceReportFilter)
