package Microsoft::AdCenter::V6::ReportingService::SitePerformanceReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::SitePerformanceReportRequest - Represents "SitePerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'SitePerformanceReportRequest';
}
...
Gets/sets Columns (ArrayOfSitePerformanceReportColumn)

=head2 Filter

Gets/sets Filter (SitePerformanceReportFilter)
