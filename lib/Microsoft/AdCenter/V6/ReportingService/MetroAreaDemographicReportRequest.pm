package Microsoft::AdCenter::V6::ReportingService::MetroAreaDemographicReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::MetroAreaDemographicReportRequest - Represents "MetroAreaDemographicReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'MetroAreaDemographicReportRequest';
}
...
Gets/sets Columns (ArrayOfMetroAreaDemographicReportColumn)

=head2 Filter

Gets/sets Filter (MetroAreaDemographicReportFilter)
