package Microsoft::AdCenter::V6::ReportingService::MetroAreaDemographicReportFilter;
...
Microsoft::AdCenter::V6::ReportingService::MetroAreaDemographicReportFilter - Represents "MetroAreaDemographicReportFilter" in Microsoft AdCenter Reporting Service.

=cut

sub _type_name {
    return 'MetroAreaDemographicReportFilter';
}
