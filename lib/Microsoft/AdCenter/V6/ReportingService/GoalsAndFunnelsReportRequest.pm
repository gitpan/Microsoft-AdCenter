package Microsoft::AdCenter::V6::ReportingService::GoalsAndFunnelsReportRequest;
...
Microsoft::AdCenter::V6::ReportingService::GoalsAndFunnelsReportRequest - Represents "GoalsAndFunnelsReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'GoalsAndFunnelsReportRequest';
}
...
Gets/sets Columns (ArrayOfGoalsAndFunnelsReportColumn)

=head2 Filter

Gets/sets Filter (GoalsAndFunnelsReportFilter)
