package Microsoft::AdCenter::V6::AdministrationService;
...
Microsoft::AdCenter::V6::AdministrationService - Service client for Microsoft AdCenter Administration Service.

=head1 SYNOPSIS

    use Microsoft::AdCenter::V6::AdministrationService;

    my $service_client = Microsoft::AdCenter::V6::AdministrationService->new
