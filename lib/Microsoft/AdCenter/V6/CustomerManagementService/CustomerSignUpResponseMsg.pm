package Microsoft::AdCenter::V6::CustomerManagementService::CustomerSignUpResponseMsg;
...
Microsoft::AdCenter::V6::CustomerManagementService::CustomerSignUpResponseMsg - Represents "CustomerSignUpResponseMsg" in Microsoft AdCenter Customer Management Service.
...
sub _type_name {
    return 'CustomerSignUpResponseMsg';
}
