package Microsoft::AdCenter::V8::AdIntelligenceService::EstimatedPositionAndTraffic;
...
Microsoft::AdCenter::V8::AdIntelligenceService::EstimatedPositionAndTraffic - Represents "EstimatedPositionAndTraffic" in Microsoft AdCenter Ad Intelligence Service.
...
our %_attribute_type = (
    ...
    CTR => 'double',
    Currency => 'Currency',
    EstimatedAdPosition => 'AdPosition',
    MatchType => 'MatchType',
...
=head2 EstimatedAdPosition

Gets/sets EstimatedAdPosition (AdPosition)
