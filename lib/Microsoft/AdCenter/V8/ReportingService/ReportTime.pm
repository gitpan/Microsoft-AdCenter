package Microsoft::AdCenter::V8::ReportingService::ReportTime;
...
Microsoft::AdCenter::V8::ReportingService::ReportTime - Represents "ReportTime" in Microsoft AdCenter Reporting Service.
