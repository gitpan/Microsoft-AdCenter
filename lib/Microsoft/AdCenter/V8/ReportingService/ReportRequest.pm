package Microsoft::AdCenter::V8::ReportingService::ReportRequest;
...
Microsoft::AdCenter::V8::ReportingService::ReportRequest - Represents "ReportRequest" in Microsoft AdCenter Reporting Service.
