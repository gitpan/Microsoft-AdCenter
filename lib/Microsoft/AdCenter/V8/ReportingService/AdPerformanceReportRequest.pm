package Microsoft::AdCenter::V8::ReportingService::AdPerformanceReportRequest;
...
Microsoft::AdCenter::V8::ReportingService::AdPerformanceReportRequest - Represents "AdPerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
Gets/sets Columns (ArrayOfAdPerformanceReportColumn)

=head2 Filter

Gets/sets Filter (AdPerformanceReportFilter)
