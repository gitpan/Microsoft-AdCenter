package Microsoft::AdCenter::V8::ReportingService::BehavioralPerformanceReportRequest;
...
Microsoft::AdCenter::V8::ReportingService::BehavioralPerformanceReportRequest - Represents "BehavioralPerformanceReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'BehavioralPerformanceReportRequest';
}
...
Gets/sets Columns (ArrayOfBehavioralPerformanceReportColumn)

=head2 Filter

Gets/sets Filter (BehavioralPerformanceReportFilter)
