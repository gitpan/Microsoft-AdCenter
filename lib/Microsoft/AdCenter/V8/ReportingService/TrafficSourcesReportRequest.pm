package Microsoft::AdCenter::V8::ReportingService::TrafficSourcesReportRequest;
...
Microsoft::AdCenter::V8::ReportingService::TrafficSourcesReportRequest - Represents "TrafficSourcesReportRequest" in Microsoft AdCenter Reporting Service.
...
sub _type_name {
    return 'TrafficSourcesReportRequest';
}
