package Microsoft::AdCenter::V8::NotificationService::CreditCardPendingExpirationNotification;
...
Microsoft::AdCenter::V8::NotificationService::CreditCardPendingExpirationNotification - Represents "CreditCardPendingExpirationNotification" in Microsoft AdCenter Notification Service.
...
sub _type_name {
    return 'CreditCardPendingExpirationNotification';
}
