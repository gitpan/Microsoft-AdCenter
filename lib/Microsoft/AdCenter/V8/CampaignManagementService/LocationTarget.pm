package Microsoft::AdCenter::V8::CampaignManagementService::LocationTarget;
...
Microsoft::AdCenter::V8::CampaignManagementService::LocationTarget - Represents "LocationTarget" in Microsoft AdCenter Campaign Management Service.
...
=head2 HasPhysicalIntent

Gets/sets HasPhysicalIntent (boolean)
