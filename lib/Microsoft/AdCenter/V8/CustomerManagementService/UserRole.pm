package Microsoft::AdCenter::V8::CustomerManagementService::UserRole;
...
Microsoft::AdCenter::V8::CustomerManagementService::UserRole - Represents "UserRole" in Microsoft AdCenter Customer Management Service.
