package Microsoft::AdCenter::V8::CustomerManagementService::Address;
...
Microsoft::AdCenter::V8::CustomerManagementService::Address - Represents "Address" in Microsoft AdCenter Customer Management Service.
