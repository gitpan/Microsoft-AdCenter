package Microsoft::AdCenter::V8::CustomerManagementService::AdvertiserAccount;
...
use base qw/Microsoft::AdCenter::V8::CustomerManagementService::Account/;

=head1 NAME

Microsoft::AdCenter::V8::CustomerManagementService::AdvertiserAccount - Represents "AdvertiserAccount" in Microsoft AdCenter Customer Management Service.

=head1 INHERITANCE

Microsoft::AdCenter::V8::CustomerManagementService::Account
